...
public class Interpret extends MathFunc implements Keywords{
    ...
    private void execute(String[] codes, StringTokenizer tk, int i) throws IOException {
        try
        {
    ...
    public static void main(String[] args) throws IOException {
        File file=new File("C:\\Users\\asus\\Desktop\\code.txt");
        ...
        Interpret i=new Interpret(program.toString());
        i.interpret(program.toString());
    }
}